...
!.....  CHOICES FOR THE FUNCTIONAL FORM OF THE CHARM WAVEFUNCTION....
     ...
     &         * ( DSQRT( Aterm / (Aterm - Bterm) ) )**3
        ...
        F2int = (Nq/(Lq**4)) * ( mN/(8.D0*pi**2) )  !A DIMENSIONLESS REDEF.!!!
...
!.....  CHOICES FOR THE FUNCTIONAL FORM OF THE CHARM WAVEFUNCTION....
        ...
        GAint = (Nq/(Lq**4)) * ( 1.D0/(16.D0*pi**2) )  !A DIMENSIONLESS REDEF.!!!
     &             * ( -kT2 + (mq + x*mN)**2 + (1.D0-x)**2*Q2/4.D0 )
     &             * ( 1.D0 / ( x**2 * (1.D0-x) ) ) * 2.D0*kT * WF 
	RETURN   
	END
...
!.....  CHOICES FOR THE FUNCTIONAL FORM OF THE CHARM WAVEFUNCTION....
        ...
        CCint = (Nq/(Lq**4)) * ( 1.D0/(16.D0*pi**2) )  !A DIMENSIONLESS REDEF.!!!
     &             * ( kT2 + (mq + x*mN)**2 - (1.D0-x)**2*Q2/4.D0 )
